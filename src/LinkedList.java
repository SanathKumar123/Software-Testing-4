 ...
 * <tt>list.LinkedList</tt> class provides uniformly named methods to <tt>get</tt>,
...
public class LinkedList<E>
{
     ...
     */
    public LinkedList(list.LinkedList<E> c)
    {
        this();
        addAll(c);
    }
     ...
     *             if the specified collection is null
     */
    public boolean addAll(list.LinkedList<E> c)
    {
     ...
     *             if the specified collection is null
     */
    public boolean addAll(int index, list.LinkedList<E> c)
    {
